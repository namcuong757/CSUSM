...
# Please follow the required user_input/output and function names
# Main function is at the end of the file
# Please call all of your completed functions and print the results out

# Please define all the needed user_input variables in your main function directly and not asking for
# user user_input. Also, please format the output from each function and print them out in the main.
import random
...
'''
4. user_input: a list with small strings that has 2 letters, 3 letters, or 4 letters
output: return 3 lists, Letter2, Letter3, Letter4 containing small strings. Print results out in the main function.
Sample:
user_input list: ['rt','asdf','ton','er','user']
will give
    Letter2=['rt','er']
    Letter3=['ton']
    Letter4=['asdf','user']
...
'''
5. user_input: a string with letters in it, a string with numbers in it.
...
'''
6. user_input: a string with letters in it, a string with numbers in it
...
user_input: a list with 10 single digit number in it
...
user_input: a list with 10 numbers in it
...
user_input: a list with 9 single digit number in it (first 9 digit in ISBN)
